...
export PATH=$PATH:/home/cjrevelas/.config/coc/extensions/coc-clangd-data/install/13.0.0/clangd_13.0.0/bin/
export PATH=$PATH:/home/cjrevelas/.local/bin
